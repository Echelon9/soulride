...
trails and buildings.  The software is based on the extreme
backcountry snowboarding game Soul Ride.

When you're done exploring our meticulous recreation of Jay Peak,
browse to http://www.jaypeakresort.com to see about visiting the real
thing!
...
Double-click the "virtual_jay_peak_1_1.exe" file after downloading
...
To uninstall, use the "Uninstall Virtual Jay Peak" icon in the
Virtual Jay Peak program group, or use the "Add/Remove Programs"
icon in the Windows Control Panel.

To run the game, go to "Start | Programs | Virtual Jay Peak" and
click on the "Virtual Jay Peak" icon.
...
purchase it later, it's OK to install Virtual Jay Peak and Soul
