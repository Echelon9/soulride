...
SoulRide links against the SDL and SDL_mixer frameworks. It is possible to distribute the frameworks with the application by putting them in Soul_Ride.app/Contents/Frameworks. A framework is a bundle of headers and shared libraries. To install them system-wide, put SDL.framework and SDL_mixer.framework in /Library/Frameworks.
